...
<center>
<br>
<font face="Helvetica" size=4><b>ANULAR VISITA CLIENTE</b></font><br>
<br>
<form action="anula_visita_cliente_exe.php" method="post">
<table>
<tr>
<td>ID</td>
<td>:</td>
...
$res=mysql_query("SELECT * FROM visita_cliente WHERE fecha='" . date('Y-m-d') . "';") or die("Note: " . mysql_error());
