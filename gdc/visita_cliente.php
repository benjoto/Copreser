...
if($_SESSION['admin']==1)
{
	...
	echo "<font face='helvetica' size=4><a href='autoriza_visita_cliente.php'>Añadir Autorizacion</a></font>";
	echo "<font face='helvetica' size=4> - </font>";
	echo "<font face='helvetica' size=4><a href='anula_visita_cliente.php'>Anular Autorizacion</a></font>";
}
echo "<hr>";
...
?>
<center><br>
<font face="Helvetica" size=4><b>AUTORIZADOS PARA VISITA CLIENTE  <?php echo date('d/m/Y'); ?> </b></font><br><br></center>
...
<td>
<?php echo mysql_result($result,$i,"nombre_cliente"); ?>
</td>
<td>
<?php echo mysql_result($result,$i,"rut_cliente"); ?>
</td>
<td>
<?php echo mysql_result($result,$i,"patente_vehiculo"); ?>
</td>
<td>
<?php echo mysql_result($result,$i,"ejecutivo_que_visita"); ?>
</td>
