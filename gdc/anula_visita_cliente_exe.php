...
$sql = "UPDATE visita_cliente SET fecha='$fecha_falsa' WHERE id='$id'";
$sql2 = "INSERT INTO anula_visita_cliente_log (id_visita_cliente, motivo, timestamp) VALUES ('$id', '$motivo', '$timestamp')";
